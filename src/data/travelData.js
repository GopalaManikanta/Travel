export const destinations = [
  {
    ...
    location: "Indonesia",
    description:
      "Experience pristine tropical beaches, ancient temples, lush rice terraces, and vibrant local culture in Bali.",
    popular: true,
  },
  {
    id: "dest-2",
    ...
    description:
      "Breathtaking mountain peaks, scenic alpine train journeys, world-class skiing, and charming luxury chalets.",
    popular: true,
  },
  {
    id: "dest-3",
    ...
    location: "Japan",
    description:
      "Immerse yourself in traditional temples, cherry blossom gardens, futuristic neon streetscapes, and culinary excellence.",
    popular: true,
  },
  {
    id: "dest-4",
    ...
    location: "Greece",
    description:
      "Iconic whitewashed cliffside villas, vibrant Aegean sea sunsets, volcanic beaches, and exquisite Mediterranean cuisine.",
    popular: false,
  },
  {
    id: "dest-5",
    ...
    location: "Kenya",
    description:
      "Witness the epic wildlife migration, luxury safari glamping under starry skies, and authentic Maasai tribal culture.",
    popular: false,
  },
  {
    id: "dest-6",
    ...
    location: "Italy",
    description:
      "Dramatic coastal cliffs, pastel villages, limoncello tasting tours, and romantic boat cruises along the Tyrrhenian Sea.",
    popular: true,
  },
];
...
export const packages = [
  {
    ...
    inclusions: [
      ...
      "Express Bullet Train Pass",
      "Guided Sightseeing Tours",
    ],
    overview:
      "A comprehensive journey covering Europe's iconic historical landmarks, romantic canals, and majestic alpine scenery.",
  },
  {
    id: "pkg-2",
    ...
    overview:
      "Unwind in pure paradise with crystal clear turquoise waters, private butler services, and luxury spa treatments.",
  },
  {
    id: "pkg-3",
    ...
    inclusions: [
      "Heritage 5-Star Hotel Stay",
      "Private AC Vehicle & Chauffeur",
      "Taj Mahal Sunrise Ticket",
      "Elephant Ride at Amber Fort",
    ],
    overview:
      "Discover royal palaces, vibrant bazaars, ancient forts, and the world-famous Taj Mahal monument of love.",
  },
  {
    id: "pkg-4",
    ...
    inclusions: [
      ...
      "Glacier Boat Navigation",
      "All Trail Permits & Meals",
    ],
    overview:
      "Hike through breathtaking granite towers, turquoise glacial lakes, and iceberg-filled fjords at the end of the world.",
  },
];
